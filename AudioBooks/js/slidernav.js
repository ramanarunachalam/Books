...
$.fn.sliderNav = function(options) {
    ...
    var defaults = { items: letters, titems: letters, debug: false, height: null, arrows: true};
    ...
    for(var i in o.items) $('.slider-nav ul', slider).append("<li><a alt='#"+o.items[i]+"'>"+o.titems[i]+"</a></li>");
